...
{
    public class BL_MISHospitalProductPurchaseReport
    {
        ...
        public DataSet MISHospitalEntryWiseReport(MISHospitalProductPurchaseReport DoctorWiseModel)
        {
            Connect();
            DataSet dsDoctorWiseCollection = null;
            try
            {
                SqlCommand cmd = new SqlCommand("GetHospitalSupplierDetails", con);
